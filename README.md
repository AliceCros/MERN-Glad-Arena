...
- Launch Mongodb: open Mongodb file, and run "npm start mongod"
- Launch Back: localhost on port:4000, run "nodemon server.js mongod"
- Front: localhost on port:3000, run "npm start"
